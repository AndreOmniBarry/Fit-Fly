...
function byId<T extends HTMLElement = HTMLElement>(id: string): T {
  ...
  if (!el) throw new Error(`hub-recommended-view: missing #${id}`);
  return el as T;
}
...
export function initHubRecommendedFeature(): void {
...
async function refreshHubRecommendedCard(): Promise<void> {
