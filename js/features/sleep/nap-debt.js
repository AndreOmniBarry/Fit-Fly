...
export function calculateNapDebtCredit(napMinutes) {
    if (napMinutes <= 0)
        return 0;
 ...
 */
export function calculateSleepDebtWithNaps(recentLogs, naps, goalMinutes = DEFAULT_SLEEP_GOAL_MINUTES) {
...
export function describeNapDebtCredit(napCreditMinutes) {
    if (napCreditMinutes <= 0)
        return null;
...
//# sourceMappingURL=nap-debt.js.map