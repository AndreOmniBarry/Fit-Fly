...
import type { NapLog } from './types.js';
...
export function totalNapMinutes(naps: Pick<NapLog, 'durationMinutes'>[]): number {
...
export function describeNapsForDate(naps: Pick<NapLog, 'durationMinutes'>[]): string | null {
