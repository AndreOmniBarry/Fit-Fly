...
export interface StepEntryLike {
...
export function calculateStepsStreak(entries: StepEntryLike[]): number {
...
export function averageStepsPerLoggedDay(entries: StepEntryLike[], days: number, today: Date = new Date()): number {
